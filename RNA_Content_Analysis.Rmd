...
Additional experiments and analyses to enhance Athanasiadou et al., paper showing that total mRNA content varies with growth rate.

We hope to answer the following in this analysis:
1. Does total mRNA content vary with growth rate when cells grow in batch culture conditions in the presence of different media?
  a.	Media Types Used
    i.	YPD
    ii.	YP-GAL
    iii.	YP-Glycerol
    iv.	Synthetic Deficient (Minimal Media)
    v.	N-limited proline
    vi.	N-limited glutamine
  b.	At mid-log we stain for
    i.	Total RNA using RNA Syto Select
    ii.	mRNA using polyA tail staining

2.	Does total mRNA content vary with growth rate when cells of different mutant genotypes, that have different growth rates, are grown in the same condition? 
a.	Strains sampled in YPD
  i.	CCR4delta0
  ii.	XRN1delta0
  iii. POP2delta0
  iv. SPF1delta0
b.	At mid-log stain for
  i.	Total RNA using RNA Syto Select
  ii.	mRNA using polyA tail staining

###############################

This experiment also loads in David's orignal run of measuring Total RNA and mRNA in various samples for comparison.
